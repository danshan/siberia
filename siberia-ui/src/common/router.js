...
export const getRouterData = app => {
  const routerConfig = {
    ...
    '/deployment/pipelines/:pipelineId': {
      component: dynamicWrapper(app, ['pipeline', 'task'], () =>
        import('../routes/Deployment/Pipeline')
      ),
    },
    '/deployment/tasklist': {
    ...
    '/deployment/applocklist': {
      component: dynamicWrapper(app, ['app', 'settings'], () =>
        import('../routes/Deployment/AppLockList')
      ),
    },
